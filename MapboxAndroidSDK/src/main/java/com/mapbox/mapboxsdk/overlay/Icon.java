...
public class Icon implements MapboxConstants
{
    ...
    protected BitmapLruCache getCache() { return getCache(null); }
     ...
     */
    public Icon(final Context context, final Size size, final String symbol, final String aColor)
	{
     ...
     * @return this icon
     */
    public Icon setMarker(final Marker aMarker)
	{
        this.marker = aMarker;
